...
$('.search-form form').submit(function(){
	$('#variable-detail-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<div class="block">
    <div class="block-title">
        <h2><strong>Variable Details</strong> Management</h2>
    </div>
    <div class="table-options clearfix">
        <div class="btn-group btn-group-sm pull-right">
            ...
            <?php echo CHtml::link('<i class="icon-plus"></i> New Variable Detail', array('admin/variabledetail/create'), array('class' => 'btn btn-success')); ?>
        </div>
    </div>
    ...
    <div class="table-responsive">
        ...
        $this->widget('zii.widgets.grid.CGridView', array(
            ...
            'columns' => array(
                ...
                array(
                    'name' => 'shortness',
                    'filter' => CHtml::activeTextField($model, 'shortness', array('id' => false, 'class' => 'form-control')),
                ),
                array(
                    'name' => 'name',
