...
$this->breadcrumbs = array(
    'Validation Result' => array('admin/test/result', 'id' => $model->test_id),
    $model->id,
);
?>
...
<div class="block">
    ...
    ?>
    <?php echo CHtml::link('<i class="fa fa-arrow-left"></i> Back', array('admin/test/result', 'id' => $model->test_id), array('class' => 'btn btn-warning', 'style' => 'margin-bottom:20px;')); ?>
</div>
