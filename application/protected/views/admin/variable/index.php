...
<div class="block">
    ...
    <div class="table-options clearfix">
        <div class="btn-group btn-group-sm pull-right">
            ...
            <?php echo AccessWebUser::call()->link('<i class="icon-plus"></i> New Variable', array('admin/variable/create'), array('class' => 'btn btn-success')); ?>
        </div>
    </div>
    ...
    <div class="table-responsive">
        ...
        $this->widget('zii.widgets.grid.CGridView', array(
            ...
            'columns' => array(
                ...
                array(
                    'name' => 'type_id',
                    'filter' => CHtml::activeDropDownList($model, 'type_id', CHtml::listData(Type::model()->findAll(), 'id', 'name'), array('id' => false, 'prompt' => '', 'class' => 'select-chosen', 'multiple' => 'multiple', 'data-placeholder' => 'Type')),
                    'header' => 'Type',
