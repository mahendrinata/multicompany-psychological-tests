...
class ExtendedClientScript extends CClientScript {
    ...
    private function combineAndCompress($type, $urls, $pos) {
        ...
        $optionsHash = ($type == 'js') ? md5($this->basePath . $this->compressJs . $this->ttlDays . $this->prefix) : md5($this->basePath . $this->compressCss . $this->ttlDays . $this->prefix . serialize($this->cssMinFilters) . serialize($this->cssMinPlugins));
