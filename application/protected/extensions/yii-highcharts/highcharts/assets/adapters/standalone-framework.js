    ...
    return{init: function(c) {
            if (!l.defaultView)
                this._getStyle = function(b, d) {
                    ...
                    if (a)
                        return b.style.zoom = 1, b[a] - 2 * parseInt(HighchartsAdapter._getStyle(b, "padding"), 10)
                };
            if (!Array.prototype.forEach)
                this.each = function(b, d) {
                    for (var a = 0, c = b.length; a < c; a++)
                        if (d.call(b[a], b[a], a, b) === !1)
                            return a
                };
            ...
            n.prototype = {update: function() {
                    ...
                    if (e.stopAnimation || e.attr && !e.element)
                        ...
                        e = c - this.startTime, this.state = e / a.duration, this.pos = a.easing(e, 0, 1, a.duration), this.now = this.start + (this.end - this.start) * this.pos, this.update(), a = !0;
                    return a
                }};
            this.animate = function(b, d, a) {
                ...
                for (g in d)
                    i = new n(b, a, g), f = null, g === "d" ? (i.paths = c.init(b, b.d, d.d), i.toD = d.d, e = 0, f = 1) : b.attr ? e = b.attr(g) : (e = parseFloat(HighchartsAdapter._getStyle(b, g)) || 0, g !== "opacity" && (h = "px")), f || (f = parseFloat(d[g])), i.custom(e, f, h)
            }
