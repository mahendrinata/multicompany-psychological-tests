...
class TagVariable extends AppActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('tag_id, variable_detail_id', 'required'),
            array('tag_id, variable_detail_id', 'numerical', 'integerOnly' => true),
            array('created_at, updated_at', 'safe'),
            // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            array('id, tag_id, variable_detail_id, created_at, updated_at', 'safe', 'on' => 'search'),
        );
    }
