...
class User extends AppActiveRecord {
    ...
    public function relations() {
        ...
        return array(
            ...
            'CreateAccess' => array(self::HAS_MANY, 'Access', 'created_by'),
            'CreatePosition' => array(self::HAS_MANY, 'Position', 'created_by'),
            'CreateRoleAccess' => array(self::HAS_MANY, 'RoleAccess', 'created_by'),
            'CreatePositionAccess' => array(self::HAS_MANY, 'PositionAccess', 'created_by'),
            'CreateStatus' => array(self::HAS_MANY, 'Status', 'created_by'),
            'UpdateAnswer' => array(self::HAS_MANY, 'Answer', 'updated_by'),
            'UpdateCompany' => array(self::HAS_MANY, 'Company', 'updated_by'),
            ...
            'UpdateAccess' => array(self::HAS_MANY, 'Access', 'updated_by'),
            'UpdatePosition' => array(self::HAS_MANY, 'Position', 'updated_by'),
            'UpdateRoleAccess' => array(self::HAS_MANY, 'RoleAccess', 'updated_by'),
            'UpdatePositionAccess' => array(self::HAS_MANY, 'PositionAccess', 'updated_by'),
            'UpdateStatus' => array(self::HAS_MANY, 'Status', 'updated_by'),
        );
    }
