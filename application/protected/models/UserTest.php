...
class UserTest extends AppActiveRecord {
    ...
    public function setExpired() {
        ...
        $this->updateAll(
            array('status' => Status::model()->getStatusIdBySlug(Status::DRAFT)), 'start_date IS NOT NULL AND start_date > :startDate AND status_id != :status', array(':startDate' => date('Y-m-d'), ':status' => Status::model()->getStatusIdBySlug(Status::DRAFT)));
