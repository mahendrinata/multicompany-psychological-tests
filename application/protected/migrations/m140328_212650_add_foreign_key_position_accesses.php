...
class m140328_212650_add_foreign_key_position_accesses extends CDbMigration {
    ...
    public function up() {
        ...
        $this->addForeignKey('fk_status_id_position_accesses', 'position_accesses', 'status_id', 'statuses', 'id', 'CASCADE', 'CASCADE');
    }
    ...
    public function down() {
        ...
        $this->dropForeignKey('fk_status_id_position_accesses', 'position_accesses');
    }
