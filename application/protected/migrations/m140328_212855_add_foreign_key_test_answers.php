...
class m140328_212855_add_foreign_key_test_answers extends CDbMigration {
    ...
    public function up() {
        ...
        $this->addForeignKey('fk_question_id_test_answers', 'test_answers', 'question_id', 'questions', 'id', 'CASCADE', 'CASCADE');
    ...
    public function down() {
        ...
        $this->dropForeignKey('fk_question_id_test_answers', 'test_answers');
