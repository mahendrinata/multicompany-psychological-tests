 ...
 */
var App = function() {
    var e = $("#page-container"), t = $("header"), a = $("#sidebar-toggle-sm"), i = $("#sidebar-toggle-lg"), s = $(".sidebar-scroll"), o = function() {
        l("init"), n(), c(), h();
        var e = $("#year-copy"), a = new Date;
        ...
        var e = 250, t = 250, a = ($(".sidebar-nav a"), $(".sidebar-nav-menu")), i = $(".sidebar-nav-submenu");
        a.click(function() {
            var a = $(this);
        ...
        "init" === o ? ((t.hasClass("navbar-fixed-top") || t.hasClass("navbar-fixed-bottom")) && l("init-scroll"), a.click(function() {
            ...
            l("toggle-lg")
        })) : "toggle-lg" === o ? e.toggleClass("sidebar-full") : "toggle-sm" === o ? e.toggleClass("sidebar-open") : "open-sm" === o ? e.addClass("sidebar-open") : "close-sm" === o ? e.removeClass("sidebar-open") : "open-lg" === o ? e.addClass("sidebar-full") : "close-lg" === o ? e.removeClass("sidebar-full") : "init-scroll" == o ? s.length && !s.parent(".slimScrollDiv").length && (s.slimScroll({height: $(window).height(), color: "#fff", size: "3px", touchScrollStep: 100}), $(window).resize(r), $(window).bind("orientationchange", d)) : "destroy-scroll" == o && s.parent(".slimScrollDiv").length && (s.parent().replaceWith(function() {
        ...
        var a, i = $(".sidebar-themes"), s = $("#theme-link");
        ...
        var o = $("#options-main-style"), n = $("#options-main-style-alt");
        ...
        var r = $("#options-header-default"), d = $("#options-header-inverse"), c = $("#options-header-top"), h = $("#options-header-bottom");
