 ...
 */
class VariableDetail extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            array('status, user_id, variable_id', 'required'),
            array('user_id, variable_id', 'numerical', 'integerOnly' => true),
            array('status', 'length', 'max' => 255),
            array('description, created_at, updated_at', 'safe'),
            // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            array('id, description, status, user_id, variable_id, created_at, updated_at', 'safe', 'on' => 'search'),
        );
    }
