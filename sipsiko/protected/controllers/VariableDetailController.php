...
class VariableDetailController extends Controller
{
    ...
    {
        $dataProvider = new CActiveDataProvider('VariableDetail');
    ...
    {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'variable-detail-form') {
