...
<div class="block">
    <div class="block-title">
        <h2>View User Public Test #<strong><?php echo $model->id; ?></strong></h2>
    </div>
    <?php
...
<div class="block">
    <div class="block-title">
        <h2>Result User Public Test #<strong><?php echo $model->id; ?></strong></h2>
    </div>
    <?php
    $this->widget('zii.widgets.CDetailView', array(
        'data' => $model,
...
<div class="block">
    <div class="block-title">
        <h2>Public User Test Answer #<strong><?php echo $model->id; ?></strong></h2>
    </div>
