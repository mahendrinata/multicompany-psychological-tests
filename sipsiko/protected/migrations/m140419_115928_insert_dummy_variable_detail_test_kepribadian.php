	...
	public function up() {
        ...
        $row = array(
            ...
            array(
                ...
                'shortness' => 'Koleris',
                'name' => 'Kekuatan',
                'description' => '<ul><li>Senang memimpin, membuat keputusan, dinamis dan aktif.</li><li>Sangat memerlukan perubahan dan harus mengoreksi kesalahan.</li><li>Berkemauan keras dan pasti untuk mencapai sasaran/ target.</li><li>Bebas dan mandiri.</li><li>Berani menghadapi tantangan dan masalah.</li><li>“Hari ini harus lebih baik dari kemarin, hari esok harus lebih baik dari hari ini”.</li><li>Mencari pemecahan praktis dan bergerak cepat.</li><li>Mendelegasikan pekerjaan dan orientasi berfokus pada produktivitas.</li><li>Membuat dan menentukan tujuan.</li><li>Terdorong oleh tantangan dan tantangan.</li><li>Tidak begitu perlu teman.</li><li>Mau memimpin dan mengorganisasi.</li><li>Biasanya benar dan punya visi ke depan.</li><li>Unggul dalam keadaan darurat.</li></ul>',
                'user_profile_id' => 2,
                'combinations' => array(
                    array(
            ...
            array(
                ...
                'shortness' => 'Koleris',
                'name' => 'Kelemahan',
                'description' => '<ul><li>Tidak sabar dan cepat marah (kasar dan tidak taktis).</li><li>Senang memerintah.</li><li>Terlalu bergairah dan tidak/susah untuk santai.</li><li>Menyukai kontroversi dan pertengkaran.</li><li>Terlalu kaku dan kuat/ keras.</li><li>Tidak menyukai air mata dan emosi tidak simpatik.</li><li>Tidak suka yang sepele dan bertele-tele / terlalu rinci.</li><li>Sering membuat keputusan tergesa-gesa.</li><li>Memanipulasi dan menuntut orang lain, cenderung memperalat orang lain.</li><li>Menghalalkan segala cara demi tercapainya tujuan.</li><li>Workaholics (cinta mati dengan pekerjaan).</li><li>Amat sulit mengaku salah dan meminta maaf.</li><li>Mungkin selalu benar tetapi tidak populer.</li></ul>',
                'user_profile_id' => 2,
                'combinations' => array(
                    array(
                        'variable_id' => $kolerisModel->id,
